...
export const PLANS = {
  standard: {
    ...
    contractor: { bidsPerMonth: 5,        activeBids: 2,         featuredSlots: 0 },
  ...
  vip: {
    ...
    contractor: { bidsPerMonth: 15,       activeBids: 5,         featuredSlots: 1 },
  ...
  elite: {
    ...
    contractor: { bidsPerMonth: 30,       activeBids: 10,        featuredSlots: 3 },
  ...
  premium: {
    ...
    contractor: { bidsPerMonth: Infinity, activeBids: Infinity,  featuredSlots: 5 },
  ...
  ultra: {
    ...
    contractor: { bidsPerMonth: Infinity, activeBids: Infinity,  featuredSlots: 10 },
    client:     { ticketsPerMonth: Infinity, activeTickets: Infinity, priorityMatching: true, featuredTicket: true },
