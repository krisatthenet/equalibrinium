...
import { FileText, Clock, CheckCircle, DollarSign, Settings, MapPin } from 'lucide-react';
                  ...
                  {loading ? (
                    ...
                    <div className="space-y-4">
                      {openTickets.map(ticket => (
                        <div key={ticket.id} className="border border-border rounded-xl p-4 hover:bg-muted/50 transition-colors duration-200">
                          ...
                          <div className="flex gap-2 mt-2">
                            <Button size="sm" asChild className="bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg">
              ...
              <Card className="bg-card border-border rounded-2xl">
                ...
                <CardContent>
                  {loading ? (
                    ...
                    <div className="space-y-4">
                      {myBids.map(bid => (
                        <div key={bid.id} className="border border-border rounded-xl p-4 hover:bg-muted/50 transition-colors duration-200">
